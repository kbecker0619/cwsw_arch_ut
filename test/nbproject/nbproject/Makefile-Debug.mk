...
${OBJECTDIR}/_ext/56252444/cwsw_event.o: ../../src/cwsw_event.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CND_CONF} -I../cfg -I../../inc -I../cwsw_lib/inc -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56252444/cwsw_event.o ../../src/cwsw_event.c

${OBJECTDIR}/_ext/511dfd52/main.o: ../app/main.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511dfd52
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CND_CONF} -I../cfg -I../../inc -I../cwsw_lib/inc -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511dfd52/main.o ../app/main.c

${OBJECTDIR}/_ext/511dfd52/sim_event_cb.o: ../app/sim_event_cb.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511dfd52
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CND_CONF} -I../cfg -I../../inc -I../cwsw_lib/inc -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511dfd52/sim_event_cb.o ../app/sim_event_cb.c

${OBJECTDIR}/_ext/f47e93e2/cwsw_lib.o: ../cwsw_lib/src/cwsw_lib.c
	${MKDIR} -p ${OBJECTDIR}/_ext/f47e93e2
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DXPRJ_NB_${CND_CONF} -I../cfg -I../../inc -I../cwsw_lib/inc -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/f47e93e2/cwsw_lib.o ../cwsw_lib/src/cwsw_lib.c
