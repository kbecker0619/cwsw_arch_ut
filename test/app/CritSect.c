 ...
 */
void
cb_event_demo_cs_enter(int protlvl, char const * const filename, int const lineno)
{
...
void
cb_event_demo_cs_leave(int protlvl, char const * const filename, int const lineno)
{
	crit_section_seen = true;
